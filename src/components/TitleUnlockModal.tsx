...
import { markTitleAsSeen, playTitleUnlockSound, sanitizeTitleDescription, normalizeTitleUpper } from "../utils/titleUtils";
...
export function TitleUnlockModal() {
  ...
  const uppercaseTitle = normalizeTitleUpper(rawTitle);
